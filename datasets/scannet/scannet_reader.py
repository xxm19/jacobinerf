...
# data_dir = "/nas/datasets/propagation_data/scans/" # path to list of scannet scenes
data_dir = "/share/datasets/scans/" # path to list of scannet scenes
val_seqs = ["scene0437_00"]
